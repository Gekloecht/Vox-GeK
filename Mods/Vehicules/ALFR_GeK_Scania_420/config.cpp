...
class CfgVehicles {
	...
	class ALFR_GeK_Scania_420: Truck_01_base_F
	{
		model 	= "\ALFR_GeK_Scania_420\ALFR_GeK_Scania_420";  /// simple path to model
		picture	= "\ALFR_GeK_Scania_420\Data\icon420.paa"; /// just some icon in command bar
		Icon	= "\ALFR_GeK_Scania_420\Data\icon420.paa"; /// icon in map
		...
		displayName = "Scania 420 Transport"; /// displayed in Editor
		
		hiddenSelections[] = {"camo1"}; ///we want to allow changing of colours

		hiddenSelectionsTextures[] = {"\ALFR_GeK_Scania_420\data\carrosserie.paa"};	 /// we could use any texture to cover the car
	...
	class ALFR_GeK_Scania_420_blanc: ALFR_GeK_Scania_420 /// some class that is going to be visible in editor
	{	
		scope	= 2; 			/// makes the car visible in editor
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		...
		displayName = "Scania 420 Transport Blanc"; /// displayed in Editor
		
		hiddenSelectionsTextures[] = {"\ALFR_GeK_Scania_420\data\carrosserie_blanc.paa"};	 /// we could use any texture to cover the car
	};
	class ALFR_GeK_Scania_420_bleu: ALFR_GeK_Scania_420 /// some class that is going to be visible in editor
	{	
		scope	= 2; 			/// makes the car visible in editor
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		...
		displayName = "Scania 420 Transport Bleu"; /// displayed in Editor

		hiddenSelectionsTextures[] = {"\ALFR_GeK_Scania_420\data\carrosserie_bleu.paa"};	 /// we could use any texture to cover the car
	};
	class ALFR_GeK_Scania_420_noir: ALFR_GeK_Scania_420 /// some class that is going to be visible in editor
	{	
		scope	= 2; 			/// makes the car visible in editor
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		...
		displayName = "Scania 420 Transport Noir"; /// displayed in Editor

		hiddenSelectionsTextures[] = {"\ALFR_GeK_Scania_420\data\carrosserie_noir.paa"};	 /// we could use any texture to cover the car
	};
	class ALFR_GeK_Scania_420_orange: ALFR_GeK_Scania_420 /// some class that is going to be visible in editor
	{	
		scope	= 2; 			/// makes the car visible in editor
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		...
		displayName = "Scania 420 Transport Orange"; /// displayed in Editor

		hiddenSelectionsTextures[] = {"\ALFR_GeK_Scania_420\data\carrosserie_orange.paa"};	 /// we could use any texture to cover the car
	};
};
