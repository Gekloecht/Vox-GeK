		...
		maxSpeed               	= 110; 		/// vehicle can go a bit over, but dramatically decreases thrust
		fuelCapacity           	= 45;
		...
		antiRollbarSpeedMin 	= 5; 	/// the roll bar force gets from zero to full in range of min and max speed
		antiRollbarSpeedMax		= 30;  	/// this simulates losing grip at high speed turns
