...
class CfgPatches
{
	class GeK_Sprinter_Ambulance
	{
		units[]				= {"GeK_Sprinter_Ambulance"};
		weapons[]			= {};
		requiredVersion		= 0.1;
...
class CfgVehicles {
	...
	class GeK_Sprinter_Ambulance: Truck_01_base_F
	{
		...
		displayName = "Ambulance - Mercedes Sprinter"; /// displayed in Editor
		
		//hiddenSelections[] = {"camo1"}; ///we want to allow changing of colours

		//hiddenSelectionsTextures[] = {"\GeK_Sprinter_Ambulance\data\ALFR_Sprinter_Ambulance_001.paa"};	 /// we could use any texture to cover the car
